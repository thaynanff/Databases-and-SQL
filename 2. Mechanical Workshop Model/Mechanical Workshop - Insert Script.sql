-- Script to insert data into the Mechanical Workshop Tables

-- ------------------------------
-- Insert into States
-- ------------------------------

INSERT INTO `mworkshop`.`state`
(`idRegion`,
`Name`,
`FU`)
VALUES
...
INSERT INTO `mworkshop`.`employees`
(`FirstName`,
`MiddleName`,
`LastName`,
`TaxID`,
...
`idCities`)
VALUES
  ("Honorato","Stanton","Winters","EZX12BPC8MO","Mechanical Assistant","Luxury cars","Ap #831-4809 Sit St.","58372-373","(120) 235-7704","vestibulum@protonmail.couk",2843),
  ("Anjolie","Crosby","Bean","GFH01SKL2PJ","Mechanical adjuster","Tinker","877-1196 Mauris Ave","58653-752","(872) 588-8087","sed.tortor@aol.org",1221),
  ("Malcolm","Ingram","Mccray","XQQ11BTG8FK","Mechanical adjuster","Luxury cars","Ap #848-6349 Sed Ave","14011-568","(893) 853-2361","dolor.sit@icloud.ca",1846),
  ("Ralph","Wolf","Kidd","USQ52QVJ0BS","Mechanic","Racing cars","8541 Felis Rd.","92160-410","(303) 440-3080","amet.dapibus.id@outlook.couk",2802),
  ("Rooney","Olson","Walker","NQK21WXB5TB","Welder","Hybrids and Electrics","507-3066 Ut Rd.","15655-177","1-823-816-6772","augue@google.ca",2205),
  ("Yolanda","Mills","Sheppard","WEU19FRU8EP","Mechanical adjuster","Racing cars","Ap #179-8566 Sed, Ave","47262-027","(573) 407-8012","nam.ligula.elit@icloud.org",5517),
  ("Kirby","Waller","Brady","RPS36WBK2DR","Mechanical adjuster","Luxury cars","P.O. Box 449, 7906 Mi Av.","58137-831","(482) 451-4855","eros@icloud.edu",29),
  ("Octavia","Lancaster","Sloan","WQH39MBL6ET","Mechanical Assistant","Tinker","P.O. Box 843, 8899 Rhoncus. Av.","88771-376","1-506-888-7341","pellentesque.habitant@protonmail.com",1986),
  ("Baker","Kerr","Melton","MHJ08SVL6GD","Mechanical adjuster","Racing cars","Ap #274-5006 Velit. Av.","37771183","1-747-645-5774","amet@google.couk",2626),
  ("Derek","Blevins","Hughes","TQF87VGW5LX","Mechanical adjuster","Racing cars","Ap #721-6698 Velit Ave","51385-774","1-599-966-6704","auctor.quis@aol.ca",5283),
  ("Reese","Knox","Mccarty","KND69BID5XU","Mechanical Assistant","Embedded Electronics","516-5318 Eu St.","61312-471","1-758-383-5137","condimentum.donec@aol.org",2179),
  ("Jacob","Vasquez","Fitzgerald","RFO50NVJ1NV","Mechanic","Tinker","Ap #339-5660 Sed St.","32637156","1-892-135-1722","posuere.cubilia@hotmail.couk",1467),
  ("Naomi","Ball","Hendrix","XRB78FYT1YW","Mechanic","Luxury cars","Ap #154-188 Eu Street","52206-765","(827) 126-7411","enim.nisl.elementum@outlook.couk",2102),
  ("Honorato","Hobbs","Giles","DNG85QVT6BY","Welder","Hybrids and Electrics","P.O. Box 950, 7125 Pede, St.","58761-837","1-503-441-7116","nascetur@protonmail.ca",3068),
  ("Charde","Alford","Hardy","IQK76ONM3EW","Mechanical adjuster","Tinker","732-6621 Luctus Av.","55253-220","1-331-943-0541","pharetra.ut@hotmail.net",80),
  ("Imogene","Rodgers","Duke","EXP52SZK8YQ","Mechanical adjuster","Embedded Electronics","Ap #380-4175 In Av.","35554579","(551) 748-6121","vivamus@yahoo.com",4202),
  ("Mariko","Fulton","Joyner","OHR29TYP3IF","Welder","Hybrids and Electrics","789 Inceptos Street","65266-175","(420) 440-5579","libero.proin@outlook.edu",1181),
  ("Ezekiel","Harmon","Davis","BPR28RHE6PO","Welder","Racing cars","1997 Commodo Road","13333-335","(815) 313-5395","scelerisque@yahoo.couk",2822),
  ("Roary","Norton","Hartman","XVD87YSQ1GU","Mechanical Assistant","Racing cars","Ap #613-1133 Ultricies Ave","51175-772","(650) 731-9550","orci@yahoo.com",2598),
  ("Erica","Slater","Harrington","OMU49CIY6KU","Mechanical Assistant","Hybrids and Electrics","Ap #476-9737 Augue. Road","95476-301","1-566-325-7674","lacus.vestibulum@outlook.net",76),
  ("Fitzgerald","Reese","Pugh","NYM41IAC8VH","Mechanic","Automatic Transmission","2358 Pharetra, Rd.","90118-451","1-644-284-7963","velit.dui.semper@hotmail.couk",3615),
  ("Autumn","Browning","Savage","BAN48ZVM0YS","Mechanical adjuster","Tinker","P.O. Box 318, 4622 Eu St.","14431-177","(458) 757-2177","scelerisque.lorem@hotmail.com",2791),
  ("Chester","Moody","Bowen","ECF12WSW4BJ","Welder","Tinker","Ap #885-5731 Amet, Ave","65485-943","(289) 618-9157","est.congue@icloud.ca",554),
  ("Amy","Wheeler","Hewitt","DGM09PBB8UU","Welder","Automatic Transmission","124-3309 Sollicitudin St.","61582-117","(284) 564-8973","massa.quisque.porttitor@protonmail.net",1795),
  ("Eric","Woods","Padilla","WOW88PJB8YQ","Mechanical Assistant","Luxury cars","3431 Ad Road","58254-425","(819) 148-4576","libero.est@protonmail.edu",717);

-- ------------------------------
-- Insert into Clients
-- -----------------------------

INSERT INTO `mworkshop`.`clients`
(`FirstName`,
`MiddleName`,
`LastName`,
`TaxID`,
...
`idCities`)
VALUES
  ("Barbara","Riley","Ferguson","VLC23DRB3XS","655-8430 Eros. Rd.","66212-351","(540) 583-8591","a.magna.lorem@icloud.ca",5191),
  ("Vincent","Flynn","Leach","HIG40HNW4LY","P.O. Box 162, 3134 Mi Street","88552-336","(950) 563-2893","libero.at@protonmail.edu",871),
  ("Jael","Kaufman","Norman","NLP23MHZ5GY","626-7482 Placerat Ave","58872-664","(284) 370-1847","ac.mattis@hotmail.couk",3673),
  ("Davis","Lane","Ashley","IGD62IRL5PF","493-7756 Urna. Rd.","62747-225","(507) 563-5562","tincidunt@protonmail.net",4502),
  ("Richard","Yates","Lowery","OLG94SRV9OW","Ap #902-1585 Pellentesque Rd.","88122-653","1-315-840-7885","donec.luctus@outlook.ca",1221),
  ("George","Shelton","Caldwell","HPH72RHJ3BY","Ap #546-1100 Cursus Av.","40042-836","(316) 432-6211","velit.in@aol.net",5538),
  ("Callie","Cortez","Mcfadden","NBA73IPM8NW","Ap #860-1722 Felis. St.","37123310","1-368-316-3134","in@aol.net",5311),
  ("Nero","Galloway","Dennis","ZBV34HMO0XF","383-419 Ut Road","23571-756","(686) 961-6325","natoque.penatibus@hotmail.edu",5316),
  ("Angelica","Manning","Mcdonald","OKH33VEQ8KN","175-8601 Eu Avenue","50403-434","1-283-529-3156","phasellus.at@hotmail.net",2012),
  ("Wesley","Winters","Ruiz","BPB71XKQ7CB","2734 Aliquet Street","22276-246","1-261-936-9153","non@outlook.com",1618),
  ("Declan","Bush","Grant","GEJ98RAK8RG","530-906 Semper Street","53611-448","(754) 455-3843","morbi.vehicula.pellentesque@icloud.net",4026),
  ("Vincent","Knapp","O'brien","IKN18GOI1NJ","2875 Porttitor St.","34537218","1-742-682-4253","donec.dignissim@hotmail.couk",829),
  ("Hashim","Ramirez","Reed","IQO13OQG2LI","7669 Ultricies Road","74735-064","(237) 507-2766","lorem.vehicula@protonmail.couk",424),
  ("Barrett","Bradley","Vincent","VNX68MYQ6SE","Ap #863-537 Nisl Rd.","38199436","1-348-384-2178","varius.orci@outlook.com",4813),
  ("Suki","Head","David","IJM51LSY2WB","Ap #907-8715 Pede, Street","89282-988","1-929-688-0698","sem.magna.nec@google.net",11),
  ("Odette","Hardin","Barry","IVS36MYC1NW","P.O. Box 634, 8655 Mi St.","67635-638","1-203-214-8528","magna.lorem@icloud.org",1734),
  ("Tanya","Austin","Velasquez","SQA18ISR4BD","Ap #169-8942 Tellus St.","27762-780","(618) 259-8716","sit@icloud.couk",902),
  ("Sandra","Ortiz","Puckett","FMG03JTR6ZR","393-1936 Velit. Street","96683-174","1-477-706-6785","leo.morbi@aol.com",576),
  ("Fuller","O'donnell","Mcbride","MSL21MGG7QB","655-2313 Ad Av.","74708-378","1-354-118-8213","tellus.sem@icloud.edu",3769),
  ("Sylvester","Lara","Hays","JQW77STX9IC","Ap #330-2683 Purus Ave","97965-754","(232) 149-2142","gravida.aliquam@google.org",4283),
  ("Halee","Guerra","Farley","UOU76FBU2WK","768-9808 Molestie Rd.","35574171","1-961-540-3418","quam@yahoo.net",3131),
  ("Tyler","Marshall","Stanton","IOO76GRB7LS","646-6598 Arcu. Avenue","25267-740","(612) 766-3231","fusce@icloud.couk",1038),
  ("Fleur","Copeland","Steele","DWQ72QCM6EC","332-6096 Ligula. Avenue","58017-158","(889) 127-9087","eu.lacus@google.ca",944),
  ("Harlan","Peterson","Mendez","TFY63XSL7FJ","Ap #498-838 Curabitur St.","58374-712","1-756-380-6164","hendrerit.id.ante@icloud.net",1186),
  ("Ruth","Chandler","Lewis","OZK58POT9DS","P.O. Box 993, 3152 Sapien St.","92242-256","1-564-237-5285","ultricies.ornare@hotmail.ca",4242),
  ("Ferdinand","Hewitt","Collins","LKU38CRY6TL","P.O. Box 931, 2122 Tristique Street","75739-366","(588) 113-1673","nunc@icloud.edu",1361),
  ("Alfreda","Avery","Ellison","ONC52TFN4SS","Ap #819-625 Quis Road","58660-283","(824) 305-1205","eu.dolor@google.net",346),
  ("Adria","Edwards","Burt","YVK59XRD7TK","P.O. Box 753, 2423 Augue Rd.","63802-274","(413) 817-1533","ut@aol.ca",1043),
  ("Melinda","Ferrell","Perry","ILH32UHF6CQ","Ap #353-813 Sed Avenue","19708-450","1-353-485-4488","lorem.vehicula@icloud.org",3357),
  ("Rahim","Raymond","Bullock","MAW16WTE2QL","7113 Mauris Av.","88117-440","1-785-542-1474","ut.quam@protonmail.com",4758),
  ("Barrett","Kelley","Reed","JLO22TVS1NM","Ap #747-5931 Amet, Road","88445-865","1-243-181-1267","bibendum.sed@aol.ca",563),
  ("Dane","Rivers","Byrd","TLJ74HDI5IC","P.O. Box 745, 2997 Sed Avenue","19624-552","1-276-387-4181","lectus@hotmail.com",3361),
  ("Amethyst","Powers","Meadows","MLQ17PMS6UX","4306 Conubia Avenue","76766-122","(876) 848-9846","ad.litora.torquent@outlook.org",3422),
  ("Ian","Solis","Velasquez","RZW25VIN7YS","P.O. Box 952, 7399 Curabitur Rd.","75734-386","1-737-206-2063","dictum.eu.placerat@hotmail.ca",676),
  ("Cole","Daugherty","Berger","NBT55KQK1UY","178-592 Cursus. Ave","37242823","(824) 455-7739","elit@hotmail.org",2782),
  ("Farrah","Chavez","Merrill","HAR78SZV5IG","P.O. Box 260, 6389 Blandit St.","76736-747","1-446-817-5488","nec.ante@hotmail.ca",291),
  ("Allen","Bryant","Carter","EKW84THD1EE","518-6373 Pellentesque St.","11352-396","1-371-666-5484","cum.sociis@aol.edu",5138),
  ("Jescie","Bailey","Matthews","PNX11DIN1AS","673-7462 Nullam St.","65704-222","(750) 692-9184","augue.ac.ipsum@icloud.net",4345),
  ("Abbot","Bird","Koch","SNE62HET4KQ","219-3147 Sapien. Ave","74738-596","(288) 741-0678","varius.orci.in@icloud.com",4059),
  ("Ignacia","Spence","Forbes","XXC66IGT2LD","365 Integer Ave","65085-753","1-489-347-4580","ornare@hotmail.net",5414),
  ("Teegan","Garcia","Mcdonald","THD96GFJ7UT","P.O. Box 933, 6118 Aliquet. St.","93896-641","(567) 392-2475","vel.pede.blandit@outlook.org",2396),
  ("Hollee","Levy","Kinney","EWI17KBH6YN","Ap #524-7875 Pede. St.","84594-088","(668) 143-7170","ipsum.primis@outlook.net",3750),
  ("Angela","Joseph","Riddle","JQN46RSV6EY","156 Mollis Avenue","88865-631","(887) 352-3268","a@outlook.ca",3280),
  ("Sydnee","Hudson","Valencia","SHN63NHT1XJ","Ap #604-6052 Massa. Road","62556-126","(762) 334-2770","ac.libero@google.org",1450),
  ("Reese","Hewitt","Moss","NGF56DTE9GV","2535 Fusce Rd.","75748-386","1-314-358-8652","nulla.eu@aol.couk",2413);

-- ------------------------------
-- Insert into suppliers
-- -----------------------------

INSERT INTO `mworkshop`.`suppliers`
(`EIN`,
`Address`,
`ZipCode`,
`Phone`,
...
`idCities`)
VALUES
  ("2391316958418","567-5344 Lacus Av.","53874-314","(75) 6 5158-1731","tincidunt.congue.turpis@yahoo.com",2517),
  ("1428925651507","5727 Amet, Av.","96345-751","(81) 3 4664-3471","dis.parturient.montes@protonmail.org",5327),
  ("2176369817713","287-1606 Molestie St.","11657-778","(93) 1 6966-6491","ornare.libero@hotmail.ca",1296),
  ("3966550486513","510-7686 Diam. St.","36565531","(26) 3 8528-8811","nullam@outlook.org",4957),
  ("4780349479244","Ap #181-9371 Vivamus St.","47335-602","(44) 5 8667-3366","nisi@yahoo.net",1468),
  ("2216704825143","4706 Nascetur Avenue","89849-772","(26) 5 5661-5813","a.purus@outlook.ca",2737),
  ("4887367178812","4843 Varius Avenue","44548-716","(21) 5 1832-4712","aenean.sed@google.edu",779),
  ("8256119923071","Ap #944-7583 Aenean Av.","58626-432","(52) 2 3117-1772","cras.interdum.nunc@aol.net",1905),
  ("3311171716533","531-6632 Aliquet Rd.","58667-605","(58) 8 4271-3234","pede.blandit@outlook.org",1426),
  ("2346087465481","5816 A, Rd.","84344-074","(73) 7 6740-2487","enim.consequat.purus@outlook.org",210),
  ("3435322268749","286-9418 Purus, St.","51828-252","(10) 3 1627-4958","vitae.risus@yahoo.edu",898),
  ("7224240287834","P.O. Box 582, 3794 Lacinia St.","55731-492","(50) 0 8283-2145","feugiat.nec@yahoo.com",388),
  ("5567506565931","P.O. Box 605, 177 Ut Road","58848-151","(76) 8 8385-8784","bibendum.donec@icloud.net",4711),
  ("0681448153248","Ap #750-9768 Malesuada. Road","63673-759","(67) 8 1342-6446","fermentum.risus@aol.org",4423),
  ("4546278558711","459-7089 Sociis Road","58471-533","(17) 5 1910-9608","aenean@icloud.edu",186),
  ("1659598774581","5011 Ac St.","92440-866","(31) 8 5184-5658","urna.justo.faucibus@protonmail.com",3948),
  ("9622952047727","803-8475 Et St.","41674-898","(64) 6 9230-8026","mi.tempor@icloud.net",3891),
  ("7988375822333","P.O. Box 529, 3508 Ipsum Rd.","74722-279","(22) 4 7761-8422","eros.nam@outlook.com",878),
  ("2785464771285","Ap #224-9719 Nec Ave","67145-666","(69) 0 5954-1267","vitae.odio@icloud.org",1507),
  ("4593817277855","6020 Sociis Av.","42662-612","(63) 6 8644-2276","ullamcorper.viverra@protonmail.ca",4327),
  ("1641959291161","Ap #251-2375 Duis Rd.","76783-321","(21) 6 6448-5934","nunc@yahoo.couk",3614),
  ("4277883565167","590-5961 Arcu. Ave","37104593","(34) 4 4216-9238","eros.non@yahoo.com",2028),
  ("7747684911224","574-4877 Laoreet Ave","65843-486","(41) 3 2194-1744","ultricies.dignissim@hotmail.edu",849),
  ("8511326026409","621-6183 Ultrices Avenue","84535-201","(33) 8 1841-6447","semper.cursus@hotmail.com",784),
  ("4243778838125","P.O. Box 407, 9276 Cras Rd.","67681-410","(15) 9 5712-4329","ipsum.primis.in@google.org",5490),
  ("3281162753008","P.O. Box 126, 6356 Vel Avenue","18285-302","(22) 2 7764-8002","vel.sapien.imperdiet@outlook.net",5046),
  ("3287594479654","Ap #506-6398 Rutrum Avenue","89374-277","(39) 5 8853-2528","placerat.augue@yahoo.net",214),
  ("8299858348346","686-5150 Phasellus Street","62677-989","(68) 4 2134-5835","ut.sagittis.lobortis@outlook.org",4653),
  ("0609731382335","913-284 Curae Street","16203-215","(92) 4 7254-2888","lorem.tristique.aliquet@outlook.couk",1509),
  ("3658953338601","P.O. Box 335, 4057 Vivamus Rd.","98412-430","(77) 4 4112-3344","metus.in.nec@outlook.ca",677),
  ("1669176362625","775-6790 Montes, Road","25564-278","(71) 5 2219-0308","integer.id@icloud.edu",2997),
  ("7319383969132","P.O. Box 117, 5616 Nibh. St.","93317-867","(77) 2 9844-1208","ut.aliquam@aol.com",2065),
  ("2267902274604","630-700 Dui Rd.","74761-034","(09) 5 1638-8264","congue.in@yahoo.net",1772),
  ("8758794538656","Ap #466-9201 Luctus St.","73763-626","(50) 7 4106-4677","justo@hotmail.net",2914),
  ("3463360338227","1195 Euismod Av.","39798453","(58) 1 9475-5637","sed.malesuada@google.edu",2373),
  ("6755886816707","Ap #654-9529 Donec Street","58799-520","(17) 6 5545-4343","donec.sollicitudin.adipiscing@yahoo.ca",3644),
  ("4132119666156","6854 A Rd.","65388-918","(40) 2 5966-1625","sem.molestie@outlook.net",1503),
  ("6921425413240","649-7923 Sit St.","38315701","(46) 9 3267-2281","integer.vulputate@outlook.edu",768),
  ("4469191987199","Ap #609-7702 Iaculis, Avenue","89412-236","(17) 8 1965-6828","mus.proin.vel@icloud.couk",4152),
  ("3861424821383","Ap #750-5823 Condimentum Avenue","58348-147","(37) 5 4110-9588","orci.ut@protonmail.net",4577);

-- ------------------------------
-- Insert into vehicles
-- -----------------------------

INSERT INTO `mworkshop`.`vehicles`
(`Model`,
`Color`,
`Year`,
`LicencePlate`,
...
`idClients`)
VALUES
  ("Jeep","blue","2019","QEP1V07","Convertible",1),
  ("Lincoln","red","1995","HFK9J14","Hatchback",2),
  ("GMC","orange","1981","RCD0H74","Hatchback",3),
  ("Peugeot","red","2007","OCH0A73","Minivan",4),
  ("GMC","orange","2006","WHN7U24","Hatchback",5),
  ("Tata Motors","blue","2021","KTR1H54","Coupe",6),
  ("Volkswagen","green","2017","EBC6D19","Convertible",7),
  ("Porsche","orange","1994","JOE5X41","Station Wagon",8),
  ("FAW","indigo","2022","FGW2K53","Sports Car",9),
  ("Toyota","blue","1999","GSU0Q45","Convertible",10),
  ("Hyundai Motors","green","2017","DGQ6H72","Station Wagon",11),
  ("Daimler","red","2016","RBP2N48","SUV",12),
  ("Volkswagen","yellow","1999","IYQ4E63","Pickup Truck",13),
  ("Mercedes-Benz","blue","1992","NGE7L64","Sedan",14),
  ("Porsche","yellow","2013","XMU7Q71","SUV",15),
  ("Nissan","indigo","1997","JGW0I89","Convertible",16),
  ("Kia Motors","indigo","2018","IIT8M74","Pickup Truck",17),
  ("Mahindra and Mahindra","blue","2018","OIT1V37","Minivan",18),
  ("Lexus","indigo","1993","LGR6R37","Sedan",19),
  ("Maruti Suzuki","indigo","2017","FLK1T30","Crossover",20),
  ("Dacia","violet","2011","DCF0D83","Hatchback",21),
  ("Daimler","violet","1988","ZLD2B89","Pickup Truck",22),
  ("Kia Motors","orange","2017","RIJ4M94","Station Wagon",23),
  ("Toyota","orange","2012","LND3Y44","Sports Car",24),
  ("Buick","violet","2015","RES7F47","Hatchback",25),
  ("Honda","yellow","1995","EFU5M65","Station Wagon",26),
  ("Skoda","indigo","2018","GZF7U66","Sedan",27),
  ("Volvo","orange","2014","LMD8L76","Convertible",28),
  ("Suzuki","yellow","2010","VGI1F84","Sports Car",29),
  ("Smart","orange","2009","WVT8P56","SUV",30),
  ("Vauxhall","orange","2020","BXS3R36","Station Wagon",31),
  ("Mercedes-Benz","orange","2003","BQJ2F18","Crossover",32),
  ("Suzuki","orange","2005","VHC2O78","Sedan",33),
  ("Daimler","red","1992","OQX3Z61","Pickup Truck",34),
  ("Volkswagen","violet","2015","UES1Q87","Minivan",35),
  ("Renault","blue","2021","KVY1M31","Station Wagon",36),
  ("JLR","indigo","2011","MNQ7O63","Crossover",37),
  ("Mercedes-Benz","red","2020","KPR3V63","Convertible",38),
  ("Cadillac","blue","2010","SOC0G12","Minivan",39),
  ("Cadillac","indigo","2014","FSS4C72","Sedan",40),
  ("Acura","blue","2002","CGR6X36","Sports Car",41),
  ("Peugeot","red","1990","KVU0I69","Coupe",42),
  ("Daihatsu","orange","2014","YTN6T13","Convertible",43),
  ("Dongfeng Motor","green","1988","HWB5V59","Hatchback",44),
  ("Kenworth","red","1981","NUX3U43","Coupe",45),
  ("GMC","green","2011","XCT9O05","Crossover",17),
  ("Tata Motors","green","2010","STX8F78","Crossover",20),
  ("Citroën","blue","2001","DJI1M41","Station Wagon",10),
  ("Toyota","red","2014","TRW7D74","SUV",5),
  ("Seat","indigo","2020","XHX2W35","Station Wagon",20),
  ("Ford","green","2022","CIY1M04","Sedan",9),
  ("Mazda","violet","1998","KOG5A62","Convertible",12),
  ("Subaru","orange","1985","NGO8M15","Pickup Truck",1),
  ("Tata Motors","blue","2002","PRT3C85","Sports Car",1),
  ("Tata Motors","blue","1977","VGN3D38","Station Wagon",9),
  ("Audi","orange","2015","DYE0I18","Convertible",3),
  ("Peugeot","yellow","1998","XVR3G81","Pickup Truck",31),
  ("MINI","yellow","1994","JUX1D85","Crossover",43),
  ("MINI","blue","1974","YOV5L22","Sedan",17),
  ("Honda","blue","2011","XDT6H47","Minivan",11),
  ("Kia Motors","orange","2017","EEW1Y64","Pickup Truck",13),
  ("Infiniti","red","2008","TJM3F13","Station Wagon",5),
  ("Maruti Suzuki","red","2002","TFJ3K22","Crossover",38),
  ("Ferrari","yellow","2003","QUJ9C65","Crossover",15),
  ("Chrysler","red","1980","FBF2F23","Minivan",14),
  ("BMW","yellow","1993","HRG8V82","Station Wagon",24),
  ("Porsche","indigo","1980","TKO7V28","Sports Car",2),
  ("JLR","violet","2018","UVQ7V87","SUV",6),
  ("Smart","yellow","1977","VXJ9D52","Station Wagon",12),
  ("Ford","red","1974","BYF5Y23","Hatchback",26);

-- ------------------------------
-- Insert into vehicles
-- -----------------------------

INSERT INTO `mworkshop`.`teams`
(`idTeams`,
`idEmployee`)
VALUES
  (1,4),
...
INSERT INTO `mworkshop`.`services`
(`TypeOfService`,
`Price`,
`Duration(Min)`,
`Description`)
VALUES
  ("Oil Change","287.71",22,"cursus et, magna."),
  ("Alignment","57.91",39,"cubilia Curae Phasellus"),
  ("Balancing","272.85",77,"ac ipsum. Phasellus"),
  ("Clutch Maintenance","686.48",49,"Aliquam erat volutpat."),
  ("Brake Components","904.74",7,"lectus rutrum urna,"),
  ("Cooling System","977.78",30,"tempor diam dictum"),
  ("Changing Air Filters","43.82",13,"aliquet, metus urna"),
  ("Autoelectric","9.45",78,"massa. Mauris vestibulum,"),
  ("Bodywork Repairs","871.06",29,"sagittis placerat. Cras"),
  ("Rectify","594.37",46,"eu, ultrices sit");

-- -----------------------------
-- Insert into services
-- -----------------------------

INSERT INTO `mworkshop`.`stockparts`
(`Parts`,
`SalePrice`,
`PurchasePrice`,
`Quantity`,
...
`LeadTime`)
VALUES
  ("Battery","265.11","146.53",7,"2026-08-26",8),
  ("Brakes","433.43","245.21",7,"2023-07-23",8),
  ("Axle","303.63","211.78",0,"2030-08-30",5),
  ("Fuel Injector","307.86","140.57",6,"2030-05-30",6),
  ("Piston","408.32","131.55",8,"2028-04-28",8),
  ("A/C Compressor","258.95","71.46",8,"2021-11-21",14),
  ("Radiator","482.17","166.82",4,"2029-12-29",10),
  ("Engine Fan","498.70","26.04",6,"2023-09-23",14),
  ("Clutch","358.81","144.26",8,"2030-07-30",3),
  ("C﻿﻿ar Jac﻿﻿k","428.54","51.16",8,"2022-06-22",4),
  ("Spare Tire","316.98","213.47",9,"2026-09-26",5),
  ("Transmission","355.71","35.48",3,"2027-03-27",13),
  ("Shock Absorbers","305.76","13.91",9,"2023-01-23",11),
  ("Air Filter","302.85","41.61",4,"2028-11-28",6),
  ("Spark Plug","416.83","13.58",3,"2028-08-28",1),
  ("Catalytic Converter","263.53","46.27",2,"2022-07-22",2),
  ("Muffler","442.02","149.75",5,"2027-10-27",14),
  ("Tire Pressure Gauge","383.13","234.35",2,"2030-04-30",4),
  ("Alternator","456.00","230.46",2,"2025-06-25",9),
  ("Power Steering Fluid","272.58","235.45",5,"2030-08-30",15);

-- -----------------------------
-- Insert into order
-- -----------------------------

INSERT INTO `mworkshop`.`orders`
(`Status`,
`ValuationDateStart`,
`ValuationDateEnd`,
`AuthorizationDate`,
...
`idClients`)
VALUES
  ("Started","2023-06-18","2022-01-14","2022-02-27","2026-12-17","2022-01-10","2022-01-28",44,2,44),
  ("Started","2023-07-20","2023-03-07","2021-12-06","2027-06-02","2021-10-11","2022-06-03",61,7,13),
  ("Started","2022-04-27","2022-11-30","2022-08-11","2030-06-16","2022-08-10","2022-10-05",57,5,31),
  ("Started","2021-10-02","2022-06-28","2022-02-12","2030-01-23","2023-05-30","2022-07-08",51,4,9),
  ("Started","2021-12-16","2023-08-23","2023-04-02","2027-02-25","2022-10-11","2023-07-12",20,4,20);


-- -----------------------------
-- Insert into omservices
-- -----------------------------

INSERT INTO `mworkshop`.`omservices`
(`idServices`,
`idOrder`)
VALUES
  (1,1),
